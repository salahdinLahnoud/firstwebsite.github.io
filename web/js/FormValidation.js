...
function validateForm() {
   return (isNotEmpty("name", "Please enter your firstname!")
        && isNotEmpty("lname", "Please enter your lastname!")
        &&isNotEmpty("street","Please enter your street")
        &&isNotEmpty("city","Please enter your city")
        &&isNotEmpty("state", "Please enter your state")
        &&isNumeric("zipcode","Plaese enter 4-digit zipcode!")
        && isNumeric("phone", "Please enter a  valid phone number!!")
        && isNumeric("zipcode", "Please enter a 5-digit zip code!")
        && isLengthMinMax("zipcode", "Please enter a 5-digit zip code!", 4, 4)
